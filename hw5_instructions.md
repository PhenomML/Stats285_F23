...
You will see that we now have 3 bash scripts: `hw5_large.sh` `hw5_cluster.sh` and `hw5_array.sh` and two python scripts: `main.py` and `map_function.py`; we also have a Jupyterlab notebook `reading_gbq.ipynb`.
