...
3. [FARMSHARE TERMINAL] In the FarmShare terminal, log into Farmshare as you did in the previous homeworks. 
...
12. Now, run the following command to complete the same task by launching a cluster:
    ```
